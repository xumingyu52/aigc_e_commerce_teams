...
function PreviewSkeleton() {
  return (
    <div className="flex h-full min-h-[420px] w-full flex-col items-center justify-center gap-4 rounded-xl bg-white p-8">
...
export function GenerationPreview({
  ...
  const content = imageUrl ? (
    <div className="relative flex h-full min-h-[420px] items-center justify-center overflow-hidden rounded-xl bg-white p-4">
      ...
      {isGenerating ? (
        <div className="absolute inset-x-0 bottom-4 flex justify-center">
          <div className="inline-flex items-center gap-2 rounded-full bg-white/95 px-4 py-2 text-sm text-gray-700 shadow-lg backdrop-blur-sm">
  ...
  return (
    <Card
      className={cn(
        "h-full rounded-xl border-0 bg-[#F8F8F8] shadow-none",
        className
      )}
    >
